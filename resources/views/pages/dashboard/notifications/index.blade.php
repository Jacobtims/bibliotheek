        ...
        <x-card class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-6 lg:py-8">
            ...
            <table class="table-auto w-full">
                ...
                <tr>
                    ...
                    <th class="py-3">Notificatie</th>
                    <th class="py-3">Verstuurd op</th>
                ...
                @foreach($notifications as $notification)
                    <tr class="even:bg-table-row">
                        ...
                        <td class="py-4">{{ $notification->notification }}</td>
                        <td class="py-4">{{ \Carbon\Carbon::parse($notification->created_at)->translatedFormat('d F Y') }}</td>
                        <td class="py-4 pr-5">
